 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "The barplot below report the number of association identified with each prior during the GORi analysis. These associations are progressively filtered out during the analysis, and can be split in four types:\n",
    "\n",
    "- **target associations** are associations between two priors; namely, a geneset you are trying to annotate, and an annotation term from a specific knowledge base.\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "- **prior_c** indicates the prior of the annotation terms in the column **consequents**.\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "# data table\n",
    "show(\n",
    "    associations[['antecedents', 'consequents', 'lift', 'n_genes', 'fdr', 'genes',  'prior_c']],\n",
